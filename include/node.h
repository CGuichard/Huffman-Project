 ...
 *
 * The structure node declared here represents a binary tree. This structure have
 * two "children", of the type node too so that a tree can be made. All nodes
 * have a tag, which is a generic tag. Our tree of node can be a tree of
 ...
 * @brief Returns the depth/height of a node.
 *
